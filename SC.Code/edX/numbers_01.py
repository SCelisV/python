...
print(f"Your birthday is: {sBirthday} ")
...
if long == 10:
    ...
    if llist == 3:
        ...
        sMontBirthday = listBirthday[1]
        sDayBirthday = listBirthday[2]
        if sYearBirthday.isnumeric() and sMontBirthday.isnumeric() and sDayBirthday.isnumeric():
            print(f"your are {year - int(sYearBirthday)} years old")
            print(f"your monthBirthday is: {sMontBirthday}")
            print(f"your dayBirthday is: {sDayBirthday}")
        else if sYearBirthday.isnumeric():

            else if sMontBirthday.isnumeric():
                    iYearBirthday = aEntero(sYearBirthday)

                else if sDayBirthday.isnumeric():
                        iYearBirthday = aEntero(sYearBirthday)

                    print(f"el día es numerico también")
                    # else:
